...
#define version_string "Compiled using cilkarts cilk++"
...
#define version_string "Compiled using intel cilk+"
...
#define version_string "Compiled using OpenMP"
...
#define cilk_for for
#define version_string "Compiled using the default compiler"
