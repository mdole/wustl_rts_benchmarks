...
./synthetic_task_utilization 12 13 0 10000 20470 2 16 0 987747 1 0 383961

echo -e "\n-----------------------------------------------------------------------------------------------"
echo -e "high.rtpt task 3: Work = 0.002989620 sec, Span = 0.000199308 sec, Period = 0.002000896 sec \n"

./synthetic_task_utilization 12 13 0 10000 163766 1 15 0 199308

echo -e "\n-----------------------------------------------------------------------------------------------"
echo -e "high.rtpt task 4: Work = 0.004194261 sec, Span = 0.000466029 sec, Period = 0.004001792 sec \n\n"

./synthetic_task_utilization 12 13 0 10000 81883 1 9 0 466029

echo -e "\n-----------------------------------------------------------------------------------------------"
echo -e "high.rtpt task 5: Work = 0.002837208 sec, Span = 0.000354651 sec, Period = 0.002000896 sec \n"

./synthetic_task_utilization 12 13 0 10000 163766 1 8 0 354651

echo -e "\n-----------------------------------------------------------------------------------------------"
echo -e "high.rtpt task 6: Work = 0.016620724 sec, Span = 0.003014045 sec, Period = 0.016007168 sec \n"

./synthetic_task_utilization 12 13 0 10000 20470 8 8 0 226664 2 0 214940 1 0 394708 2 0 406432 5 0 290169 2 0 426949 5 0 254997 12 0 799186
